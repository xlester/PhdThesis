...
In Table 3.1, we show the errors values of the estimated phase-shifts using our
...
3.1.(b) shows the recovered phase using the regularized self-tuning
demodulation method presented here, while Fig. 3.1.(c) shows the recovered
...
Fig. 3.1.(b) and Fig. 3.1.(c) are calculated as standard deviation of
