...
\end{table}
, we show the errors values of the estimated phase-shifts using our
...
\bibitem{a5}C. Ai and J. C. Wyant, "Effect of
piezoelectric transducer nonlinearity on phase shift interferometry,"
Appl. Opt. 26, 1112\textendash{}1116 (1987).

\bibitem{a6}K. Larkin, \textquotedblleft{}A self-calibrating phase-shifting
...
\bibitem{a10} P. Hariharan, B. F. Oreb, and T. Eiju, \textquotedblleft{}
Digital
...
\bibitem{a11} Y. Surrel, \textquotedblleft{}Phase stepping: a new
self-calibrating algorithm.\textquotedblright{} Applied optics 32,
3598\textendash{}3600 (1993).

\bibitem{a12} J. C. Estrada, M. Servin, and J. A. Quiroga, \textquotedblleft{}
Easy
...
\bibitem{a17} K. G. Larkin, D. J. Bone, and M. a. Oldfield,
...
\bibitem{a20} B. Jahne, Digital Image Processing (Springer, 2005).

\bibitem{a21} J. Nocedal and S. JW, Numerical Optimization, Operations
