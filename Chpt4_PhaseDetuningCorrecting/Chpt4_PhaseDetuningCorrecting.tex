...
\cite{Malacara,GeneralTheory,Mosinio, fringePatternAnalisys}. In literature, we
can find several works that study and measure the effects of the detuning error
and the factors that cause it \cite{PhaseDetuning_0, PhaseDetuning_1, 
PhaseDetuning_2, PhaseDetuning_3, AccuracyPSI_0, AccuracyPSI_1, AccuracyPSI_2,
AccuracyPSI_3, AccuracyPSI_4, AccuracyPSI_5}. For example, in phase shifting
...
\section{Phase detuning correction method (PDCM)}
...
\section{Appendix. Local frequency calculation in presence of noise}
...
2005).
 ...
 \bibitem{GeneralTheory}M. Servin, J. C. Estrada, and J. A. Quiroga, “The 
  ...
  \bibitem{Mosinio} J. Mosi\~{n}o, M. Servin, J. Estrada, and
  ...
  \bibitem{fringePatternAnalisys} M. Servin, J. Antonio Quiroga and M. Padilla, 
...
"Calculus 
  ...
  \bibitem{AccuracyPSI_2} P. Groot, "Phase-shift calibration errors in 
  interferometers with spherical Fizeau cavities," Appl. Opt. \textbf{34}, 
  2856-2863 (1995) %doi: http://dx.doi.org/10.1364/AO.34.002856.

\bibitem{AccuracyPSI_3} J. Schmit and K. Creath, “Extended averaging technique
...
\bibitem{AccuracyPSI_4} B. Gutmann and H. Weber, "Phase-Shifter 
...
\bibitem{AccuracyPSI_5} M. Servin, J. C. Estrada, and J. A. Quiroga, “Spectral 
