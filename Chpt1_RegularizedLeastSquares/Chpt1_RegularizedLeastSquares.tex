...
Each $(x,y)$ pixel of the PSI sequence is a 1D temporal discrete
...
each pixel has the same model [see Eq. \eqref{eq:psi sequence}], the
...
%% ------------------- Marroquin references ---------------------
  ...
  \bibitem{Vargas} J. Vargas, J. Quiroga, C. Sorzano, J. Estrada, and J. Carazo,
